...
public class ProfilDeaktivierenControlTest
{
    ...
    @InjectMocks
    private final ProfilDeaktivierenControl profilDeaktivierenControl = new ProfilDeaktivierenControl(personRepository, unternehmenRepository);
    ...
    void deactivatePersonSuccessfulPersonInactive()
    {
        ...
        assertTrue(profilDeaktivierenControl.profilDeaktivierenPerson(person));
    ...
    void deactivateManagerUnternehmenSuccessfulUnternehmenInactive()
    {
        ...
        assertTrue(profilDeaktivierenControl.profilDeaktivierenUnternehmen(manager));
    ...
    void deactivatePersonUnternehmenSuccessfulPersonInactive()
    {
        ...
        assertTrue(profilDeaktivierenControl.profilDeaktivierenPerson(personU2));
