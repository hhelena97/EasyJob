...
public class StudentRegistrierungsController extends RegistrierungsController {
    final
     ...
     * @param
     */
    public StudentRegistrierungsController(StudentRepository studentRepository, StudienfachRepository studienfachRepository, JobKategorieRepository jobKategorieRepository, BrancheRepository brancheRepository, BerufsFeldRepository berufsFeldRepository, OrtRepository ortRepository) {
        super();
