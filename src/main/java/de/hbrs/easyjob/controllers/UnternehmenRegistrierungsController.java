...
@RestController
public class UnternehmenRegistrierungsController {
    final
    ...
    @Autowired
    public UnternehmenRegistrierungsController(UnternehmenRepository unternehmenRepository, BrancheRepository brancheRepository, OrtRepository ortRepository) {
        super();
