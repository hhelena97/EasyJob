...
public class JobSpecification {
    ...
    /**
     * Erstellt eine Spezifikation für die Filterung von JobsUebersichtView basierend auf einen Ort.
     * @param orte
    ...
    /**
     * Erstellt eine Spezifikation für die Filterung von JobsUebersichtView und erzeugt dynamische Suchkriterien, um JobsUebersichtView zu finden,
     * die einem oder mehreren der angegebenen Studienfächer entsprechen.
     * @param studienfacher Kann leer sein oder eine Menge sein
     * @return Eine Spezifikation Instanz, die als Filterkriterium für die Jobsuche verwendet wird.
     * Gibt alle JobsUebersichtView zurück, wenn die Menge leer oder null ist.
     */
    ...
    /**
     * Erstellt eine Spezifikation für die Filterung von JobsUebersichtView basierend auf eine Jobkategorie.
     * @param kategorien
     * @return Eine Spezifikation Instanz, die als Filterkriterium für die Jobsuche verwendet wird.
     */
