...
import de.hbrs.easyjob.control.StudentProfilController;
import de.hbrs.easyjob.entities.Student;

@Route(value = "s" , layout = StudentenLayout.class)
@RouteAlias(value = "studierendProfil" , layout = StudentenLayout.class)



public class studierendProfil extends VerticalLayout {
    ...
    studierendProfil(){
        UI.getCurrent().getPage().addStyleSheet("studierendProfil.css");
        ...
        RouterLink link = new RouterLink(EinstellungenStudent.class);
        link.add(cog);
