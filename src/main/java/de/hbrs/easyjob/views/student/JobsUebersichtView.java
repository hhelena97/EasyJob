...
public class JobsUebersichtView extends VerticalLayout {
    ...
    @Autowired
    public JobsUebersichtView(JobService jobService, JobSucheService jobSucheService, JobFilterService jobFilterService) {
    ...
    private void initializeView() {
        ...
        // JobsUebersichtView laden und anzeigen
        loadJobs();
    ...
    private void addJobComponentToLayout(Job job) {
        ...
        // JobDetailsView wie Unternehmen und Ort und Homeoffice
