...
import de.hbrs.easyjob.services.JobFilterService;
...
public class JobFilteringView extends VerticalLayout {
    ...
    @Autowired
    public JobFilteringView(UnternehmenService unternehmenService, JobFilterService jobFilterService, JobService jobService) {
    ...
    public void initializeView(){
        ...
        Button showJobsButton = new Button("JobsUebersichtView anzeigen");
    ...
    private void filterAndNavigate() {
        ...
        // Navigieren zur JobsUebersichtView-Ansicht
