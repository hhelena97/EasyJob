...
public class UnternehmenPerson extends VerticalLayout {
    ...
    UnternehmenPerson(){
        UI.getCurrent().getPage().addStyleSheet("UnternehmenPerson.css");
        ...
        //EinstellungenUnternehmen Icons
        Icon cog = new Icon(VaadinIcon.COG);
        cog.addClassName("iconsProf");

        RouterLink link = new RouterLink(EinstellungenUnternehmen.class);
        link.add(cog);
